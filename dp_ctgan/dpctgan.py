...
from dp_ctgan.rdp_accountant import compute_rdp, get_privacy_spent
...
class DPCTGAN(CTGAN):
    ...
    def __init__(self, embedding_dim=128, generator_dim=(256, 256), discriminator_dim=(256, 256),
        ...
        super(DPCTGAN, self).__init__(embedding_dim, generator_dim, discriminator_dim,
    ...
    def fit(self, train_data, discrete_columns=tuple()):
        ...
        optimizerD = optim.Adam(
            discriminator.parameters(), lr=self._discriminator_lr, #betas=self._betas,
